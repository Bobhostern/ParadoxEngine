...
/**
 * @file
 * @brief Generated from tileset.xsd.
 */

#ifndef SRC_XSD_TILESET_H
#define SRC_XSD_TILESET_H
...
/**
 * @brief Class corresponding to the %tileset_t schema type.
 *
 * @nosubgrouping
 */
class tileset_t: public ::xml_schema::type
{
  public:
  /**
   * @name tile
   *
   * @brief Accessor and modifier functions for the %tile
   * sequence element.
   */
  //@{
...
/**
 * @brief Class corresponding to the %tile_t schema type.
 *
 * @nosubgrouping
 */
class tile_t: public ::xml_schema::type
{
  public:
  /**
   * @name property
   ...
   * @brief Attribute type.
   */
  typedef ::property_t property_type;
   ...
   * @brief Attribute type.
   */
  typedef ::xml_schema::string texture_type;
  ...
  ::xsd::cxx::tree::one< texture_type > texture_;

  //@endcond
};

/**
 * @brief Enumeration class corresponding to the %property_t
 * schema type.
 */
class property_t: public ::xml_schema::string
{
  public:
  ...
  {
    return _xsd_property_t_convert ();
  }
  ...
  public:
  static const char* const _xsd_property_t_literals_[3];
  static const value _xsd_property_t_indexes_[3];
...
/**
 * @name Parsing functions for the %tileset document root.
 */
//@{
 ...
 */
::std::auto_ptr< ::tileset_t >
tileset (::xercesc::InputSource& is,
         ::xml_schema::flags f = 0,
         const ::xml_schema::properties& p = ::xml_schema::properties ());
...
void
operator<< (::xercesc::DOMElement&, const tileset_t&);

void
operator<< (::xercesc::DOMElement&, const tile_t&);

void
operator<< (::xercesc::DOMElement&, const property_t&);

void
operator<< (::xercesc::DOMAttr&, const property_t&);
...
/**
 * @name Serialization functions for the %tileset document root.
 */
//@{
 ...
 */
void
tileset (::xercesc::XMLFormatTarget& ft,
         const ::tileset_t& x, 
         const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
         const ::std::string& e = "UTF-8",
         ::xml_schema::flags f = 0);
